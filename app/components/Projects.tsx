...
const Projects: React.FC<PropertyPageProps> = ({ properties }) => {
  ...
  return (
    <section
      className={`max-w-screen-xl px-4 bg-white ${properties.length > 0 ? "md:pb-20 pb-10" : "flex items-center justify-center min-h-96"}`}
    >
      {properties.length > 0 ? (
        <div className="container mx-auto lg:w-11/12">
          ...
          <div className="text-center">
            <Link
              href="/listings"
              className="inline-block px-8 py-3 bg-primary text-white rounded-md hover:bg-primary/80 transition-colors"
            >
              View More
            </Link>
          </div>
